...
import centralLogoImg from "/assets/uploads/IMG_20260322_092930-1.png";
import logoBioImg from "/assets/uploads/LOGO-Bio-1.png";
import labDetailsImg from "/assets/uploads/Laboratory-details-1.png";
import nblLogoImg from "/assets/uploads/NBL-logo-2-2.png";
import nanoCourseImg from "/assets/uploads/Nano-Course-brief-2.gif";

import contactAngleInfoImg from "/assets/uploads/Contact-angle-1-3.png";
// Instrument Information Images
import ftirInfoImg from "/assets/uploads/FTIR-1-1.png";
import lyophilizerInfoImg from "/assets/uploads/Lyophilizer-vacuum-concentrator-1-2.png";
import probeSonicatorInfoImg from "/assets/uploads/Probe-sonicator-1-4.png";
import zetasizerInfoImg from "/assets/uploads/Zetasizer-1.png";

import bandageFishSkinImg from "/assets/uploads/Bandage-Fish-Skin-3.png";
import greenNanoCureImg from "/assets/uploads/GreenNanoCure-5.png";
import hydrophobicImg from "/assets/uploads/Hydrophobic-nanoconjugate-4.png";
import nubioflexImg from "/assets/uploads/NuBioFlex-2.png";
// Project Images
import sanisafeImg from "/assets/uploads/SANISAFE-1.png";

// labDetailsImg imported above -- used in About section PNG display
const _keepLabDetails = labDetailsImg;
...
const INSTRUMENTS = [
  ...
  },
  {
    ...
    info: contactAngleInfoImg as string,
  ...
  },
  {
    ...
    info: lyophilizerInfoImg as string,
  ...
  },
  {
    ...
    info: probeSonicatorInfoImg as string,
  ...
  },
  {
    ...
    info: zetasizerInfoImg as string,
    sop: null as string | null,
  },
];

function getInstrumentIcon(id: string, size = 32) {
  switch (id) {
    case "ftir":
...
const PROJECTS = [
  {
    id: 1,
    title: "SANISAFE",
    image: sanisafeImg as string,
  },
  {
    id: 2,
    title: "NuBioFlex",
    image: nubioflexImg as string,
  },
  {
    id: 3,
    title: "Bandage - Fish Skin",
    image: bandageFishSkinImg as string,
  },
  {
    id: 4,
    title: "Hydrophobic nanoconjugate",
    image: hydrophobicImg as string,
  },
  {
    id: 5,
    title: "GreenNanoCure",
    image: greenNanoCureImg as string,
  },
];
...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col">
      {/* Department Selection Popup -- plain div overlay, no Radix Dialog to avoid pointer-events bug */}
      {showDeptPopup && (
        <div
        ...
        >
          <div className="bg-white rounded-2xl shadow-2xl p-8 max-w-sm w-full mx-4">
            ...
            <div className="flex flex-col gap-3">
              <button
                type="button"
                className="w-full py-4 rounded-lg text-white text-base font-semibold"
              ...
              <button
                type="button"
                className="w-full py-4 rounded-lg border text-gray-700 text-base font-semibold hover:bg-gray-50"
      ...
      <header className="sticky top-0 z-40 bg-white shadow-md">
        <div className="max-w-7xl mx-auto px-4 py-1 flex items-center justify-between gap-4">
          ...
          <img
            ...
            className="h-28 w-auto max-w-[220px] object-contain flex-shrink-0"
          />
          ...
          {instrumentModal && (
            <>
              ...
              <div className="grid grid-cols-1 gap-3 mt-2">
                ...
                {/* Instrument Information -- dropdown toggle */}
                {instrumentModal.info ? (
                  <div className="border rounded-lg overflow-hidden">
                    <button
                      type="button"
                      className="w-full flex items-center justify-between px-4 py-3 bg-gray-50 hover:bg-gray-100 font-semibold text-sm text-left"
                      onClick={() => setShowInstrumentInfo(!showInstrumentInfo)}
                      data-ocid="services.info_toggle"
                    >
                    ...
                    {showInstrumentInfo && (
                      <div className="p-3">
                        <img
                          ...
                          alt={`${instrumentModal.name} Information Sheet`}
      ...
      {/* Lab SOP Modal */}
      <Dialog open={labSopOpen} onOpenChange={setLabSopOpen}>
        <DialogContent
          ...
          {projectModal && (
            <>
              ...
              <img
                ...
                className="w-full rounded-lg mt-2 object-contain"
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600 leading-relaxed">
                  ...
                  &amp; Research, MIT-ADT University, Loni Kalbhor, Pune-412201
                </p>
              </div>
            </div>
          </div>
